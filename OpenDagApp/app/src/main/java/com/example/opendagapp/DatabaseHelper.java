...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_DATABASE_HROOPENDAY = "hro_opendays.db";
    ...
    public static final String DB_TABLE_LOCATION_ZIPCODE = "zip_code"; // text
    ...
    public static final String DB_TABLE_IMAGE_FLOORNUMBER = "floor_number"; // text
